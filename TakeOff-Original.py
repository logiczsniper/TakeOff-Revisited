...
def victory():
    ...
    while victory:
        ...
        button(" Again?", 150, 560, 100, 50, Constants.PURPLE, Constants.DARK_PURPLE, level_one)
        button(" Quit!", 750, 560, 100, 50, Constants.PURPLE, Constants.DARK_PURPLE, quit_game)
...
def elevation(km):
    ...
    text = font.render("Kilometres: " + str(km), True, Constants.BLACK)
...
def crash():
    ...
    while True:
        ...
        button(" Again?", 150, 560, 100, 50, Constants.RED, Constants.DARK_RED, level_one)
        button(" Quit!", 750, 560, 100, 50, Constants.RED, Constants.DARK_RED, quit_game)
...
def paused():
    ...
    while pause:
        ...
        TextRect.center = ((display_width / 2), (display_height / 2))
        gameDisplay.blit(TextSurf, TextRect)
        button(" Go on!", 150, 560, 100, 50, Constants.BLUE, Constants.DARK_BLUE, unpause)
        button(" Quit!", 750, 560, 100, 50, Constants.BLUE, Constants.DARK_BLUE, quit_game)
...
def game_intro():
    ...
    while intro:
        ...
        TextRect.center = ((display_width / 2), (display_height / 2))
        gameDisplay.blit(TextSurf, TextRect)
        button(" Play!", 150, 560, 100, 50, Constants.GREEN, Constants.DARK_GREEN, level_one)
        button(" Quit!", 750, 560, 100, 50, Constants.GREEN, Constants.DARK_GREEN, quit_game)
...
def level_three():
    ...
    while not gameExit:
        ...
        if y < thing_starty + thing_height:
            if thing_startx < x < thing_startx + thing_width and not y + rocket_height < thing_starty + thing_height or thing_startx < x + rocket_width < thing_startx + thing_width and not y + rocket_height < thing_starty + thing_height:
                crash()
        if height == 60:
            level_four()
